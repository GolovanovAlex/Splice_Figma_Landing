...
Использование препроцессинга **SASS**, модуль гибкого контейнера **Flexbox**, дополнительно **Grid**, сборщика **Gulp**. Использована библиотека **animated**. Пройдена валидация HTML и CSS.
